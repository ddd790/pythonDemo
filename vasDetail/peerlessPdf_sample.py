...
class VAS_GUI():
    ...
    def get_files(self):
        ...
        self.add_data_title = ['FileName', 'FileNameJ', 'Version', 'Item', 'PO', 'Material', 'MaterialNo', 'Description', 'Component', 'FabricNo', 'Qty', 'ZROH',
                               ...
                               'Rmk', 'HSCode', 'DeliverTo', 'CreateDate']
        # 数字类型的字段
...
___________________________________________________________________________________________________________________'''
    ...
    def file_to_dataframe_pdfplumber(self, fileName, create_time):
        ...
        # deliverTo
        deliverTo = ''
        if tx.__contains__('200 Industrial'):
            deliverTo = '200'
        elif tx.__contains__('8888 Boulevard'):
            deliverTo = '8888'
        # 去掉无用的数据
    ...
    def update_db(self):
        ...
        for tabVal in self.table_value:
            insertValue += tabVal
        insertSql = 'INSERT INTO D_Peerless_Order_Sample (' + (
    ...
    def select_po_old_value(self):
        ...
        select_sql = 'select ' + strCol + ' from D_Peerless_Order_Sample'
